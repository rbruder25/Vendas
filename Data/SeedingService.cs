    ...
    public class SeedingService
    {
        ...
        public void Seed()
        {
                ...
                _context.SalesRecord.Any())
            {
                ...
                return; //  O banco de dados já foi pulado
            }
//Departamento
            Department d1 = new Department(1, "Conpulters");
...
//Vendedores
            ...
            Seller s3 = new Seller(3,"Alex Grey","alex@gmail.com", new DateTime(15,1,15),2200.0,d1);
            Seller s4 = new Seller(4,"Martha Red ","mastha@gmail.com", new DateTime(1993,11,30),3000.0,d4);
